                ...
                <div class="col-md-8">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <input type="text" class="form-control" id="title" name="title" placeholder="{{ __('voyager::generic.title') }}"  value="{{ old('title', $dataTypeContent->title ?? $dataTypeContent->excerpt ?? '') }}" required>
                        </div>
                    </div>
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <textarea class="form-control" name="excerpt" required>{{ old('excerpt', $dataTypeContent->excerpt ?? $dataTypeContent->excerpt ?? '') }}</textarea>
                        </div>
                    </div>
                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="slug" name="slug"
                                    ...
                                    value="{{ old('slug', $dataTypeContent->slug ?? $dataTypeContent->slug ?? '') }}">
                            </div>
                            <div class="form-group">
                                ...
                                <option value="draft"@if(isset($dataTypeContent->status) && $dataTypeContent->status == 'draft') selected="selected"@endif>{{ __('voyager.post.status_draft') }}</option>
                                    <option value="edit"@if(isset($dataTypeContent->status) && $dataTypeContent->status == 'edit') selected="selected"@endif>{{ __('voyager.post.status_edit') }}</option>
                                    <option value="review"@if(isset($dataTypeContent->status) && $dataTypeContent->status == 'review') selected="selected"@endif>{{ __('voyager.post.status_review') }}</option>
                    ...
                    <div class="panel panel-bordered panel-info">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="seo_title" placeholder="SEO Title" value="{{ old('seo_title', $dataTypeContent->seo_title ?? $dataTypeContent->seo_title ?? '') }}">
                            </div>
                        </div>
                    </div>
                </div>
